...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="validate/validateregeditjsp.js"></script>
				...
				<ul class="forminfo">
					<li>
						...
						<input name="userName" type="text" class="dfinput" id="userName"
							value="${userName}" onblur="clearUserNameMsg()" maxlength="20" />
						<i><span id="pleaseInputUserName"
							style="background: url(images/error.png) no-repeat left center; color: red; display: none; padding-left: 20px; font-size: 12px;">请您输入用户名称！</span>
						</i>
					</li>
					<li>
						<label>
					...
					<li>
						...
						<input name="name" type="text" class="dfinput" id="name"
							onblur="clearNameMsg()" maxlength="20" />
					...
					<li>
						...
						<input name="edu" type="text" class="dfinput" maxlength="20"
							id="edu" onblur="clearEduMsg()" />
					...
					<li>
						...
						<input name="works" type="text" class="dfinput" maxlength="50"
							id="works" onblur="clearWorksMsg()" />
					...
					<li>
						...
						<input name="phone" type="text" class="dfinput" maxlength="11"
							id="phone" onblur="clearPhoneMsg()" />
					...
					<li>
						...
						<input name="email" type="text" class="dfinput" maxlength="50"
							id="email" onblur="clearEmailMsg()" />
					...
					<li>
						...
						<input name="nation" type="text" class="dfinput" maxlength="50"
							id="nation" onblur="clearNationMsg()" />
					...
					<li>
						...
						<input name="birth" type="text" class="dfinput" maxlength="50"
							id="birth" onblur="clearBirthMsg()" />
					...
					<li>
						...
						<textarea name="place" cols="" rows="" class="textinput"
							id="place" onkeydown="stoplength();"></textarea>
					...
					<li>
						...
						<input name="" type="submit" class="btn" value="注册用户" />
						<input name="" type="button" class="btn" value="返回登录"
							onclick="goHome()" />
					</li>
				</ul>
			</form>
